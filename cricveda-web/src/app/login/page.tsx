    ...
    <div className="min-h-screen flex items-center justify-center px-4" style={{ background: "var(--color-bg-primary, #06080d)" }}>
      <div className="w-full max-w-md">
        ...
        <div className="rounded-2xl p-8" style={{ background: "rgba(255,255,255,0.025)", border: "1px solid rgba(255,255,255,0.06)" }}>
          {error && (
            <div className="mb-5 p-3 rounded-lg text-sm" style={{ background: "rgba(239,68,68,0.08)", border: "1px solid rgba(239,68,68,0.2)", color: "#fca5a5" }}>
          ...
          <button
            ...
            style={{
              ...
              color: loading ? "#6b7280" : "#f0f0f5",
              cursor: loading ? "not-allowed" : "pointer",
            }}
          >
            {loading ? (
              <span className="w-5 h-5 rounded-full border-2 animate-spin" style={{ borderColor: "rgba(255,255,255,0.2)", borderTopColor: "#818cf8" }} />
            ) : (
